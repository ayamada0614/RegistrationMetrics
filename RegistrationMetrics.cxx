...
// 10/22/2012 ayamada
// based on TransformFiducialList.cxx
...
int main(int argc, char** argv){
  ...
  // 5/14/2012 ayamada
  std::cerr << "numMeas1 :" << numMeas1 << std::endl;
  std::cerr << "numMeas2 :" << numMeas2 << std::endl;
  ...
  // 5/14/2012 ayamada
  std::cerr << "hd1 :" << hd1 << std::endl;
  std::cerr << "hd2 :" << hd2 << std::endl;
  ...
  std::ofstream outMetricsFile(outputFile.c_str());
  outMetricsFile << "DSC, " << pIn[0] << ", " << "HD, " << pIn[1] << std::endl;
  std::cout << "DSC, " << pIn[0] << ", " << "HD, " << pIn[1] << std::endl;
  outMetricsFile.close();
